...
public class kcklx extends AbstractLanguageAnalyser {

  private static final Logger log = Logger.getLogger(kcklx.class);
  ...
  /**
   * Execute this vdsv over the current document.
  ...
  public void execute() throws ExecutionException {
    ...
    // long.
    if(isInterrupted()) {
      throw new ExecutionInterruptedException("Execution of vdsv has been interrupted!");
    }
    interrupted = false;
